define([
	...
	'dojo-testing/NodeList-html',
	'dojo-testing/NodeList-dom'
], function (registerSuite, assert, query, domConstruct, declare, template) {
	...
	registerSuite(function () {
		...
		return {
			...
			'nodelist html': function () {
				...
				var markup = '<li data-dojo-testing-type="SimpleThing">1</li>' +
					'<li data-dojo-testing-type="SimpleThing">2</li>' +
					'<li data-dojo-testing-type="SimpleThing">3</li>';
				var liNodes;
