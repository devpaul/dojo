...
], function (registerSuite, assert, sinon, html, parser, declare, Deferred, domConstruct, query,
			 arrayUtil, template) {
		...
		return {
			...
			'.set': {
				...
				'parseContent: true': function () {
					...
					var content = '<div data-dojo-testing-type="SimpleThing" data-dojo-testing-id="ifrs" data="{}"></div>';
					var options = {
						parseContent: true,
						postscript: function () {
							this.set();
				...
				'_ContentSetter': function () {
					...
					var args = [
						[ 'simple' ],
						[
							'<div data-dojo-testing-type="SimpleThing" data-dojo-testing-id="id00">parsed content</div>',
							{ parseContent: true }
						],
						[
							'<div data-dojo-testing-type="SimpleThing" data-dojo-testing-id="id01">parsed content</div>',
							{ parseContent: true }
						]
					];
